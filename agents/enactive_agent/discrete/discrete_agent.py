...
from agents.single_agent.discrete.discrete_nn import Discrete_NN
...
class Discrete_Agent(AgentBase):
    def __init__(self, reward_config=None, agent_save_mode="origin"):
    ...
    def after_step_for_train(self, env):
        ...
        self.current_episode_reward_origin = sum_rewards_origin
    ...
    def print_train_log(self):
        ...
        with open('../../train/result/discrete/d4.txt', 'ab') as f:
