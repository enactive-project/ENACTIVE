...
authorization_code = ''
class BattleSpace:
    """
    ...
    def random_init(self):
        ...
        if type(self.init_interface["red_awacs"]) is list:
            for i in range(self.blue):
                if side == 0:  # red -- blue
                    self.init_interface["red_awacs"][i]["init_xg_0_est"]["value"] = self.border_x - 15000.0
                    self.init_interface["red_awacs"][i]["init_xg_1_est"]["value"] = 0
                    self.init_interface["red_awacs"][i]["init_xg_2_est"]["value"] = -6000
                    self.init_interface["red_awacs"][i]["init_vg_0_est"]["value"] = -400
                    self.init_interface["red_awacs"][i]["init_vg_1_est"]["value"] = 0
                    self.init_interface["red_awacs"][i]["init_vg_2_est"]["value"] = 0

                elif side == 1:  # blue -- red
                    self.init_interface["red_awacs"][i]["init_xg_0_est"]["value"] = -self.border_x + 15000.0
                    self.init_interface["red_awacs"][i]["init_xg_1_est"]["value"] = 0
                    self.init_interface["red_awacs"][i]["init_xg_2_est"]["value"] = -6000
                    self.init_interface["red_awacs"][i]["init_vg_0_est"]["value"] = 400
        ...
        if type(self.init_interface["blue_awacs"]) is list:
            for i in range(self.red):
                if side == 0:  # red -- blue
                    self.init_interface["blue_awacs"][i]["init_xg_0_est"]["value"] = -self.border_x + 15000.0
                    self.init_interface["blue_awacs"][i]["init_xg_1_est"]["value"] = 0
                    self.init_interface["blue_awacs"][i]["init_xg_2_est"]["value"] = -6000
                    self.init_interface["blue_awacs"][i]["init_vg_0_est"]["value"] = 400
                    self.init_interface["blue_awacs"][i]["init_vg_1_est"]["value"] = 0
                    self.init_interface["blue_awacs"][i]["init_vg_2_est"]["value"] = 0
        ...
        for i, aircraft in enumerate(
            ...
            if (side == 0 and i < self.red) or (side == 1 and i >= self.red):  # red
                ...
                aircraft["init_x"]["value"] = np_random.uniform(-self.border_x + 25000.0, -self.border_x + 35000.0)
                aircraft["init_y"]["value"] = np_random.uniform(-10000.0, 10000.0)
                aircraft["init_z"]["value"] = np_random.uniform(-11000, -6000)
                ...
                aircraft["init_x"]["value"] = np_random.uniform(self.border_x - 35000.0, self.border_x - 25000.0)
                aircraft["init_y"]["value"] = np_random.uniform(-10000.0, 10000.0)
                aircraft["init_z"]["value"] = np_random.uniform(-11000, -6000)
                aircraft["init_mu"]["value"] = 0
                aircraft["init_gamma"]["value"] = 0
        ...
        while True:
            if "blue_awacs" in env.action_interface.keys():
                for i in range(env.red):
                    ...
                    env.action_interface["blue_awacs"][i]["action_vg_0_est"]["value"] = 0
                    env.action_interface["blue_awacs"][i]["action_vg_1_est"]["value"] = 0
            ...
            if "red_awacs" in env.action_interface.keys():
                for i in range(env.blue):
                    ...
                    env.action_interface["red_awacs"][i]["action_vg_0_est"]["value"] = 0
                    env.action_interface["red_awacs"][i]["action_vg_1_est"]["value"] = 0
                    env.action_interface["red_awacs"][i]["action_vg_2_est"]["value"] = 0
            
            for i, action in enumerate(env.action_interface["AMS"]):
                if i < env.red:  # red

                    action["BotManeuver"]["combat_mode"]["value"] = 0
                    action["BotManeuver"]["maneuver_target"]["value"] = 2
                    action["BotManeuver"]["vel_cmd"]["value"] = 400
                    action["BotManeuver"]["horizontal_cmd"]["value"] = 1
                    action["BotManeuver"]["vertical_cmd"]["value"] = 1
                    action["BotManeuver"]["ny_cmd"]["value"] = 8
                    action["BotManeuver"]["flag_after_burning"]["value"] = 1
                    action["BotManeuver"]["clockwise_cmd"]["value"] = 1
                    action["BotManeuver"]["base_direction"]["value"] = 10
                    ...
                    action["BotManeuver"]["combat_mode"]["value"] = 0
                    action["BotManeuver"]["maneuver_target"]["value"] = 0
                    action["BotManeuver"]["vel_cmd"]["value"] = 400
                    action["BotManeuver"]["horizontal_cmd"]["value"] = 1
                    action["BotManeuver"]["vertical_cmd"]["value"] = 1
                    action["BotManeuver"]["ny_cmd"]["value"] = 8
