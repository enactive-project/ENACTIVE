...
from agents.single_agent.semantic.semantic_nn import Semantic_NN
...
class Semantic_Agent(AgentBase):
    ...
    def before_step_for_sample(self, env):
        ...
        hor, ver, shoot, v_c, nn_c = model.select_action(self.states_global, self.states_native, msl_token_self,
        ...
        # if self.side == 0:
        #     with open('/home/qiaor2/ysq/alphaniao/train/result/semantic/action/si/hor.txt', 'ab') as f:
        #         if hor_out[0] is not np.nan:
        #             np.savetxt(f, [int(hor_out[0])], delimiter=" ")
        #     with open('/home/qiaor2/ysq/alphaniao/train/result/semantic/action/si/ver.txt', 'ab') as f:
    ...
    def after_step_for_train(self, env):
        ...
        shape_reward, shape_reward_origin = reward_methed_1v1.get_shape_reward(env, self.side, self.interval, self.reward_config)
        reward += shape_reward
        ...
        if done:
            ...
            self.sampler_log["reward_sum_origin"] = self.sampler_log["reward_sum_origin"] + self.current_episode_reward_origin
    ...
    def print_train_log(self):
        ...
        with open('../../train/result/semantic/s5.txt', 'ab') as f:
